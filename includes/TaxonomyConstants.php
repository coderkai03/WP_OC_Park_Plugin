...
class TaxonomyConstants {
  ...
  /**
   * Allowed term slugs for Amenities taxonomy. Only these are assigned on import/save.
   *
   * @var string[]
   */
  ...
  /**
   * Allowed term slugs for Activities taxonomy. Only these are assigned on import/save.
   *
   * @var string[]
   */
